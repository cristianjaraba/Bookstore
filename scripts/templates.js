                ...
                <div class="book-content">
                    <div class="book-price-likes">
                        ...
                        <div class="book-likes">
                            <p>${books[i].likes}</p>
                            <button onclick="toggleLikeAndLiked()" class="like-btn">
                                <svg stroke="black" stroke-width="1" id="heart-icon" xmlns="http://www.w3.org/2000/svg"
                                    width="16" height="16" fill="#07516a" class="bi bi-heart-fill" viewBox="0 0 16 16">
